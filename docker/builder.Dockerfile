...
LABEL org.opencontainers.image.title="Headless Blender Character Builder" \
      ...
      org.opencontainers.image.base.name="debian:bookworm-20260713-slim" \
